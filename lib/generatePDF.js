  ...
  const htmlContent = `
    ...
    <head>
      ...
      <style>
        ...
        .notes-area { 
          border: 1px solid #ccc; height: 40px; margin-top: 10px; 
        ...
        .sig-box { text-align: center; width: 200px; margin-top: 70px;}
        .sig-box2 { text-align: center; width: 200px; margin-top: 10px; }
    ...
    <body>
        ...
        <div class="photo-section">
          ${student.imageUrl 
            ...
            ${(student.facedFinalExam || student.finalExamResults) ? `
              <div style="margin-top: 15px; padding: 8px; border: 1px solid #ddd; border-radius: 4px; font-size: 10px; text-align: left;">
                <div style="font-weight: bold; color: #800000; margin-bottom: 6px; text-align: left;">
                  ${isSi ? 'අවසාන විභාගයේ ප්‍රතිඵල' : 'Final Exam Results'}
                </div>
                ${student.facedFinalExam && hasFinalExamResults ? `
                  <div style="font-size: 10px; line-height: 1.5; text-align: left;">
                    <div style="margin-bottom: 3px;"><span style="font-weight: bold;">Buddha Charithay / බුද්ධ චරිතය:</span> ${student.finalExamResults.buddha_charithay || '—'}</div>
                    <div style="margin-bottom: 3px;"><span style="font-weight: bold;">Buddha Sanskruthiya / බුද්ධ සංස්කෘතිය:</span> ${student.finalExamResults.buddha_sanskruthiya || '—'}</div>
                    <div style="margin-bottom: 3px;"><span style="font-weight: bold;">Pali Abhidharma / පාලි අභිධර්ම:</span> ${student.finalExamResults.pali_abhidharma || '—'}</div>
                    <div style="margin-bottom: 3px;"><span style="font-weight: bold;">Shasana Ithihasaya / ශාසන ඉතිහාසය:</span> ${student.finalExamResults.shasana_ithihasaya || '—'}</div>
                  </div>
      ...
      <div class="admin-section">
        ...
        <div class="signature-grid">
          ...
          <div class="sig-box2">
            <img src="/images/sign_proper.png" alt="Principal's Signature" style="width: 120px; height: auto;">
            <div class="sig-line"></div>
